...
#+HTML_HEAD_EXTRA: <link rel="canonical" href="https://avi.press/posts/2026-07-10-after-7-years-in-production-scarf-has-reluctantly-moved-away-from-haskell.html" />
#+HTML_HEAD_EXTRA: <meta property="og:site_name" content="Avi Press" />
#+HTML_HEAD_EXTRA: <meta property="og:type" content="article" />
#+HTML_HEAD_EXTRA: <meta property="og:title" content="After 7 years in production, Scarf has reluctantly moved away from Haskell" />
#+HTML_HEAD_EXTRA: <meta property="og:description" content="After 7 years in production, Scarf has reluctantly moved away from Haskell — Avi Press" />
#+HTML_HEAD_EXTRA: <meta property="og:url" content="https://avi.press/posts/2026-07-10-after-7-years-in-production-scarf-has-reluctantly-moved-away-from-haskell.html" />
#+HTML_HEAD_EXTRA: <meta property="og:image" content="https://avi.press/images/og/2026-07-10-after-7-years-in-production-scarf-has-reluctantly-moved-away-from-haskell.png" />
#+HTML_HEAD_EXTRA: <meta name="twitter:card" content="summary_large_image" />
#+HTML_HEAD_EXTRA: <meta name="twitter:title" content="After 7 years in production, Scarf has reluctantly moved away from Haskell" />
#+HTML_HEAD_EXTRA: <meta name="twitter:description" content="After 7 years in production, Scarf has reluctantly moved away from Haskell — Avi Press" />
#+HTML_HEAD_EXTRA: <meta name="twitter:image" content="https://avi.press/images/og/2026-07-10-after-7-years-in-production-scarf-has-reluctantly-moved-away-from-haskell.png" />

[[file:../index.org][Avi Press]] | July 10, 2026
...
This has been a hard post to write. I almost didn't write it at all, since I prefer to build and promote than to critique. However, I hope this post can add constructively to the discussion about Haskell’s future. I must underline that I'm not writing this criticizing Haskell from the outside. I care enough about Haskell to be honest about why [[https://about.scarf.sh][Scarf]] has reluctantly moved away from it, in hopes it sways people in the community to take this feedback seriously.
...
Since Scarf launched, our backend has been built in Haskell. The main API that powers our app uses libraries like Servant, Beam for PostgreSQL, and even our own client for ClickHouse. We also built a high-performance Haskell service for Scarf Gateway directly on top of WAI, which sits directly in the download path for a high volume of open source package traffic. These systems have real uptime requirements, contractually committed SLAs, and we have managed that successfully in production for years.
...
An AI-enabled Haskell ecosystem would ask different questions. How do we make Haskell easier for agents to use well? How do we get more high-quality Haskell examples into model training data? How can we scale reviews? How do we make library docs full of copy-pastable, realistic examples, not just beautiful types? How do we make project bootstrap fast? How should we handle contributions when the volume and variance of quality of PRs skyrockets? How do we reduce cold build times? How do we make common industrial patterns obvious to a model that is trying to help?
...
#+BEGIN_EXPORT html
<p>
  <a href="https://x.com/gdb/status/2007228511363444905">
    <img class="embedded-post-image" src="../images/posts/2026-07-10-gdb-tweet.png" alt="Screenshot of a Greg Brockman tweet about Rust being a perfect language for agents, with replies mentioning Haskell." />
  </a>
</p>
#+END_EXPORT
